...
-->
      <div style="  margin-left: 55px; color: #FF8A78; font-size: 18px; font-weight: bold;"><?= $_SESSION['username'];?></div>
        ...
        <a id="admin_block" href="/templates/main_content/admin_tools.php">Додати новину</a><br/>
        <img src="/images/folder.png" width="20px" height="20px" style="margin-left: 20px; margin-top: 13px;">
        <a id="admin_block" href="/templates/main_content/oblik.php">Мій обліковий запис</a><br/>
        <img src="/images/logout.png" width="23px" height="23px" style=" margin-left: 20px; margin-top: 13px;">
        <a  id="admin_block" href="/templates/includes/logout.php">Вийти</a><br/>
        <?php
    }
    else{
        require($_SERVER['DOCUMENT_ROOT']."/templates/scripts/authorization.php");
    }
    ?>
</div>
