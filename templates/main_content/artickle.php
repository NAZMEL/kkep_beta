        ...
        <div id= "new" > 
          <img src="/images/user.png" title="Автор новини" alt="Автор новини" style=" position: absolute; width: 15px; height: 15px; margin-top: 3px;"/>
            ...
            if(isset($_SESSION['id'])){
                ...
                include_once($_SERVER['DOCUMENT_ROOT']."/templates/scripts/edit_news.php");}
            }?>
...
-->
          ...
          ?>
            ...
            <hr style="color: grey; border-style: dashed;"/>
             ...
             <?php require_once($_SERVER['DOCUMENT_ROOT']."/templates/scripts/like.php"); ?>
    <br/><br/>             
     ...
     <?php
        ...
        echo '<div id="comment_one">';
                    ...
                    $avatar = get_avatar(get_id_author($comment[$i]['comment_author']));
                        if($avatar == '') {$avatar = "/images/admin/default.png";}
                        ...
                        <div id="comment_content">
                          <?php
                           ...
                           ?>
                           <form action="/templates/includes/comment_edit.php?name=save" method="post">
                    ...
                    if(isset($_SESSION['username'])){
                        ...
                        ?>
                            ...
                            $_SESSION['id_news']  = $news['id'];
                                ?>
                                <a id="comment_change" href="/templates/includes/comment_edit.php?name=edit">Редагувати</a><span id="comment_change" >|</span>
                                <a id="comment_change" href="/templates/includes/comment_edit.php?name=delete">Видалити</a>
                            </div><br/>
                            <?php
                        }
                    }
